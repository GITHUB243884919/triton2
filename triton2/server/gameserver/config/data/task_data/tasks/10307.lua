task = {
  ...
  accept_cond = 
  {
	{func=check_today_completedbygroup, args={group_id = 524332,max_times = 1}},
  ...
  awards = 
  {
	{func=award_option_items, args={id1 = 64762,n1 = 1,id2 = 0,n2 = 0,id3 = 0,n3 = 0,id4 = 0,n4 = 0,id5 = 0,n5 = 0,id6 = 0,n6 = 0,id7 = 0,n7 = 0,id8 = 0,n8 = 0,is_free = 0}},
};
  --接受任务奖励
  accept_awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_10307_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_10307_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_10307_dialog_accept_npctalk_4",
	buttons = {
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_10307_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_10307_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_10307_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_10307_dialog_end_npctalk_5",
	buttons = {
