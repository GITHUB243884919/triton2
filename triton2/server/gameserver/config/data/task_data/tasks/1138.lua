task = {
  ...
  desc = "#td_1138_desc",  
  dest = "#td_1138_dest",  
  section = "#td_1138_section",  
  give_npc = 36097,    --发放NPC
  ...
  accept_cond = 
  {
	{func=check_before_task, args={task_id = 1137}},
  };
  --发布任务条件
  publish_cond = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_1138_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_1138_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 349 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_1138_dialog_accept_npctalk_349",
	buttons = {
        { player_talk = "#td_1138_dialog_accept_player_talk_349_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 3},
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_1138_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_1138_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_1138_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 407 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_1138_dialog_end_npctalk_407",
	buttons = {
        { player_talk = "#td_1138_dialog_end_player_talk_407_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 4},
