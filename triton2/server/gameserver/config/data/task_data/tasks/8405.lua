task = {
  ...
  complete_cond = 
  {
	{func=check_use_item, args={id = 39374,n = 1}},
  };
  --任务完成奖励
  awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8405_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_8405_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 290 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_8405_dialog_accept_npctalk_290",
	buttons = {
        { player_talk = "#td_8405_dialog_accept_player_talk_290_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 3},
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8405_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8405_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_8405_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 291 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_8405_dialog_end_npctalk_291",
	buttons = {
        { player_talk = "#td_8405_dialog_end_player_talk_291_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 4},
