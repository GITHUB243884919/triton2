task = {
  ...
  give_npc = 36779,    --发放NPC
  give_map_id = 63,    --发放NPC所在的地图ID
  recv_npc = 36779,    --回收NPC
  ...
  --护送NPC路径
  npc_waypoints = {};
  drop_items = {{npc_id=44905 ,item_id=36031 ,n=1 ,p=3000, mapid=63},{npc_id=44906 ,item_id=36031 ,n=1 ,p=3000, mapid=63},{npc_id=44907 ,item_id=36031 ,n=1 ,p=3000, mapid=63}};   --掉落道具
  --接任务条件
  accept_cond = 
  {
