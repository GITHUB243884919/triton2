task = {
  ...
  complete_cond = 
  {
	{func=check_talk_withnpc, args={id = 36091}},
  };
  --任务完成奖励
  awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_5065_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_5065_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 6 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_5065_dialog_accept_npctalk_6",
	buttons = {
        { player_talk = "#td_5065_dialog_accept_player_talk_6_1" ,dest_type = 1 ,dest_window_id = 0 ,func_code = 0},
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_5065_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_5065_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_5065_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 7 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_5065_dialog_end_npctalk_7",
	buttons = {
        { player_talk = "#td_5065_dialog_end_player_talk_7_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 4},
...
[36091] = {
	...
	parent_id = 0,
	window_type = 4,
	npc_talk ="#td_5065_dialog_npc_36091npctalk_1",
	buttons = {
        { player_talk = "#td_5065_dialog_npc_36091player_talk_1_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 10},

  }
},
actions = 
{
	{func=award_talk_withnpc, args={id = 36091}},
};
