task = {
  ...
  --护送NPC路径
  npc_waypoints = {};
  drop_items = {{npc_id=44915 ,item_id=35986 ,n=1 ,p=5000, mapid=5},{npc_id=44916 ,item_id=35986 ,n=1 ,p=5000, mapid=5},{npc_id=44917 ,item_id=35986 ,n=1 ,p=5000, mapid=5}};   --掉落道具
  --接任务条件
  accept_cond = 
  {
