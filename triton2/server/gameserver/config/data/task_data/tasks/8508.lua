task = {
  ...
  give_items = {};   --发放道具
  --护送NPC路径
  npc_waypoints = {{x=22,y=63,map=9},{x=26,y=66,map=9},{x=30,y=70,map=9},{x=35,y=75,map=9},{x=38,y=78,map=9},{x=44,y=84,map=9}};
  drop_items = {};   --掉落道具
  --接任务条件
  accept_cond = 
  {
  ...
  complete_cond = 
  {
	{func=check_send_npc, args={id = 39963}},
  };
  --任务完成奖励
  awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8508_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_8508_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 3},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_8508_dialog_accept_npctalk_4",
	buttons = {
        { player_talk = "#td_8508_dialog_accept_player_talk_4_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 3},
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8508_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8508_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_8508_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_8508_dialog_end_npctalk_5",
	buttons = {
        { player_talk = "#td_8508_dialog_end_player_talk_5_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 4},
