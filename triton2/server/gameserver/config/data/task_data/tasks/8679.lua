task = {
  ...
  complete_cond = 
  {
	{func=check_many_orges_by_killed, args={id1 = 45221,id2 = 45222,id3 = 45223,id4 = 0,id5 = 0,n = 50}},
  };
  --任务完成奖励
  awards = 
  {
	{func=award_expr, args={expr = 24700}},
	{func=award_money, args={money = 988,is_free = 0}},
};
  --接受任务奖励
  accept_awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8679_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_8679_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_8679_dialog_accept_npctalk_4",
	buttons = {
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8679_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8679_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_8679_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_8679_dialog_end_npctalk_5",
	buttons = {
