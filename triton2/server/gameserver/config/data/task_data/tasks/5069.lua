task = {
  ...
  complete_cond = 
  {
	{func=check_talk_withnpc, args={id = 36089}},
  };
  --任务完成奖励
  awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_5069_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_5069_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 400 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_5069_dialog_accept_npctalk_400",
	buttons = {
        { player_talk = "#td_5069_dialog_accept_player_talk_400_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 3},
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_5069_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_5069_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_5069_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 399 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_5069_dialog_end_npctalk_399",
	buttons = {
        { player_talk = "#td_5069_dialog_end_player_talk_399_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 4},
...
[36089] = {
	...
	parent_id = 0,
	window_type = 4,
	npc_talk ="#td_5069_dialog_npc_36089npctalk_1",
	buttons = {
        { player_talk = "#td_5069_dialog_npc_36089player_talk_1_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 10},

  }
},
actions = 
{
	{func=award_talk_withnpc, args={id = 36089}},
};
