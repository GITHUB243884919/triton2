task = {
  ...
  desc = "#td_9720_desc",  
  dest = "#td_9720_dest",  
  section = "#td_9720_section",  
  give_npc = 46943,    --发放NPC
  give_map_id = 65,    --发放NPC所在的地图ID
  recv_npc = 46943,    --回收NPC
  ...
  accept_cond = 
  {
	...
	{func=check_today_completedbygroup, args={group_id = 4194305,max_times = 1}},
  ...
  complete_cond = 
  {
	{func=check_orges_by_killed, args={id = 59660,n = 1}},
  };
  --任务完成奖励
  awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9720_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_9720_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 1,
	npc_talk ="#td_9720_dialog_accept_npctalk_4",
	buttons = {
        { player_talk = "#td_9720_dialog_accept_player_talk_4_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 4,
	window_type = 3,
	npc_talk ="#td_9720_dialog_accept_npctalk_5",
	buttons = {
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9720_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9720_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_9720_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 6 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_9720_dialog_end_npctalk_6",
	buttons = {
