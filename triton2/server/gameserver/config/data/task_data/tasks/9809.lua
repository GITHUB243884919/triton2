task = {
  ...
  desc = "#td_9809_desc",  
  dest = "#td_9809_dest",  
  section = "#td_9809_section",  
  give_npc = 61240,    --发放NPC
  give_map_id = 60,    --发放NPC所在的地图ID
  recv_npc = 61240,    --回收NPC
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9809_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_9809_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 1,
	npc_talk ="#td_9809_dialog_accept_npctalk_4",
	buttons = {
        { player_talk = "#td_9809_dialog_accept_player_talk_4_1" ,dest_type = 1 ,dest_window_id = 7 ,func_code = 0},
	...
	parent_id = 4,
	window_type = 3,
	npc_talk ="#td_9809_dialog_accept_npctalk_7",
	buttons = {
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9809_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9809_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_9809_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 1,
	npc_talk ="#td_9809_dialog_end_npctalk_5",
	buttons = {
        { player_talk = "#td_9809_dialog_end_player_talk_5_1" ,dest_type = 1 ,dest_window_id = 6 ,func_code = 0},
	...
	parent_id = 5,
	window_type = 2,
	npc_talk ="#td_9809_dialog_end_npctalk_6",
	buttons = {
