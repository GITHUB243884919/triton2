task = {
  ...
  accept_cond = 
  {
	{func=check_today_completedbygroup, args={group_id = 524331,max_times = 1}},
	{func=check_activity_on, args={id = 89}},
  };
  --发布任务条件
  publish_cond = 
  {
  ...
  awards = 
  {
	{func=award_option_items, args={id1 = 64595,n1 = 1,id2 = 64594,n2 = 1,id3 = 69879,n3 = 1,id4 = 69883,n4 = 1,id5 = 69881,n5 = 1,id6 = 69878,n6 = 1,id7 = 69882,n7 = 1,id8 = 69880,n8 = 1,is_free = 0}},
};
  --接受任务奖励
  accept_awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_10306_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_10306_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_10306_dialog_accept_npctalk_4",
	buttons = {
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_10306_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_10306_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_10306_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_10306_dialog_end_npctalk_5",
	buttons = {
