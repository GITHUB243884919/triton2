task = {
  ...
  awards = 
  {
	{func=award_expr, args={expr = 21930}},
	{func=award_money, args={money = 1100}},
	{func=award_items, args={id = 39506,n = 1}},
};
  --接受任务奖励
  accept_awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8103_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_8103_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_8103_dialog_accept_npctalk_4",
	buttons = {
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8103_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8103_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_8103_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_8103_dialog_end_npctalk_5",
	buttons = {
        { player_talk = "#td_8103_dialog_end_player_talk_5_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 4},
