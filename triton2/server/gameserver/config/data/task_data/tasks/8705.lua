task = {
  ...
  desc = "#td_8705_desc",  
  dest = "#td_8705_dest",  
  section = "#td_8705_section",  
  give_npc = 39261,    --发放NPC
  give_map_id = 64,    --发放NPC所在的地图ID
  recv_npc = 40135,    --回收NPC
  ...
  --护送NPC路径
  npc_waypoints = {};
  drop_items = {{npc_id=45217 ,item_id=40157 ,n=1 ,p=5000, mapid=30},{npc_id=45218 ,item_id=40157 ,n=1 ,p=5000, mapid=30},{npc_id=45219 ,item_id=40157 ,n=1 ,p=5000, mapid=30},{npc_id=45220 ,item_id=40157 ,n=1 ,p=5000, mapid=30}};   --掉落道具
  --接任务条件
  accept_cond = 
  {
  ...
  complete_cond = 
  {
	{func=check_items_of_bag, args={id = 40157,n = 20}},
  };
  --任务完成奖励
  awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8705_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_8705_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_8705_dialog_accept_npctalk_4",
	buttons = {
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8705_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8705_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_8705_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_8705_dialog_end_npctalk_5",
	buttons = {
