task = {
  ...
  complete_cond = 
  {
	{func=check_items_of_bag, args={id = 37993,n = 1}},
  };
  --任务完成奖励
  awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_5067_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_5067_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 8 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_5067_dialog_accept_npctalk_8",
	buttons = {
        { player_talk = "#td_5067_dialog_accept_player_talk_8_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 3},
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_5067_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_5067_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_5067_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 9 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_5067_dialog_end_npctalk_9",
	buttons = {
        { player_talk = "#td_5067_dialog_end_player_talk_9_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 4},
...
[36085] = {
	...
	parent_id = 0,
	window_type = 4,
	npc_talk ="#td_5067_dialog_npc_36085npctalk_1",
	buttons = {
        { player_talk = "#td_5067_dialog_npc_36085player_talk_1_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 10},

  }
},
actions = 
{
	{func=award_items, args={id = 37993,n = 1}},
};
