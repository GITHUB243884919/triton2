task = {
  ...
  --护送NPC路径
  npc_waypoints = {};
  drop_items = {{npc_id=37445 ,item_id=75007 ,n=1 ,p=10000, mapid=21},{npc_id=40324 ,item_id=75007 ,n=1 ,p=10000, mapid=56},{npc_id=40328 ,item_id=75007 ,n=1 ,p=10000, mapid=57}};   --掉落道具
  --接任务条件
  accept_cond = 
  {
