task = {
  ...
  desc = "#td_9806_desc",  
  dest = "#td_9806_dest",  
  section = "#td_9806_section",  
  give_npc = 61237,    --发放NPC
  give_map_id = 1,    --发放NPC所在的地图ID
  recv_npc = 61237,    --回收NPC
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9806_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_9806_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 1,
	npc_talk ="#td_9806_dialog_accept_npctalk_4",
	buttons = {
        { player_talk = "#td_9806_dialog_accept_player_talk_4_1" ,dest_type = 1 ,dest_window_id = 8 ,func_code = 0},
	...
	parent_id = 4,
	window_type = 3,
	npc_talk ="#td_9806_dialog_accept_npctalk_8",
	buttons = {
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9806_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9806_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_9806_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 1,
	npc_talk ="#td_9806_dialog_end_npctalk_5",
	buttons = {
        { player_talk = "#td_9806_dialog_end_player_talk_5_1" ,dest_type = 1 ,dest_window_id = 6 ,func_code = 0},
	...
	parent_id = 5,
	window_type = 1,
	npc_talk ="#td_9806_dialog_end_npctalk_6",
	buttons = {
        { player_talk = "#td_9806_dialog_end_player_talk_6_1" ,dest_type = 1 ,dest_window_id = 7 ,func_code = 0},
	...
	parent_id = 6,
	window_type = 2,
	npc_talk ="#td_9806_dialog_end_npctalk_7",
	buttons = {
