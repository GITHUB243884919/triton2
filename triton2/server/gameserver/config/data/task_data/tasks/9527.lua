task = {
  ...
  desc = "#td_9527_desc",  
  dest = "#td_9527_dest",  
  section = "#td_9527_section",  
  give_npc = 52341,    --发放NPC
  give_map_id = 42,    --发放NPC所在的地图ID
  recv_npc = 52341,    --回收NPC
  recv_map_id = 42,    --回收NPC所在的地图ID
  hard = 0,    --任务难度
  timer = 3600,    --任务时限(秒)
  ...
  group_id = 131074,    --任务子类别
  is_fail_auto_abort = 0,    --是否失败时自动放弃
  is_share_complete = 1,    --同屏玩家是否分享任务成功
  ...
  accept_cond = 
  {
	{func=check_today_completedbygroup, args={group_id = 131074,max_times = 1}},
	{func=check_is_corps_member, args={nouse = 0}},
	{func=check_mutex_by_group, args={group_id = 131074}},
  ...
  complete_cond = 
  {
	{func=check_orges_by_killed, args={id = 55329,n = 1}},
  };
  --任务完成奖励
  awards = 
  {
	...
	{func=award_corps_glory, args={value = 20}},
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9527_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_9527_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 1,
	npc_talk ="#td_9527_dialog_accept_npctalk_4",
	buttons = {
        { player_talk = "#td_9527_dialog_accept_player_talk_4_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 4,
	window_type = 3,
	npc_talk ="#td_9527_dialog_accept_npctalk_5",
	buttons = {
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9527_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9527_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_9527_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 6 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_9527_dialog_end_npctalk_6",
	buttons = {
