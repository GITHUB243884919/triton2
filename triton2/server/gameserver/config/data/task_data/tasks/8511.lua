task = {
  ...
  give_items = {};   --发放道具
  --护送NPC路径
  npc_waypoints = {{x=37,y=94,map=12},{x=33,y=96,map=12},{x=33,y=97,map=12},{x=32,y=97,map=12},{x=32,y=99,map=12},{x=31,y=99,map=12},{x=31,y=102,map=12},{x=31,y=111,map=12},{x=31,y=115,map=12},{x=29,y=115,map=12},{x=29,y=117,map=12},{x=25,y=117,map=12},{x=25,y=126,map=12}};
  drop_items = {};   --掉落道具
  --接任务条件
  accept_cond = 
  {
  ...
  complete_cond = 
  {
	{func=check_send_npc, args={id = 39964}},
  };
  --任务完成奖励
  awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8511_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_8511_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 3},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_8511_dialog_accept_npctalk_4",
	buttons = {
        { player_talk = "#td_8511_dialog_accept_player_talk_4_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 3},
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8511_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8511_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_8511_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_8511_dialog_end_npctalk_5",
	buttons = {
        { player_talk = "#td_8511_dialog_end_player_talk_5_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 4},
