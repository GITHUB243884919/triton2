task = {
  ...
  desc = "#td_10551_desc",  
  dest = "#td_10551_dest",  
  section = "#td_10551_section",  
  give_npc = 75714,    --发放NPC
  give_map_id = 164,    --发放NPC所在的地图ID
  recv_npc = 75733,    --回收NPC
  ...
  accept_cond = 
  {
	{func=check_before_task, args={task_id = 10550}},
  };
  --发布任务条件
  publish_cond = 
  {
  ...
  awards = 
  {
	{func=award_items, args={id = 76122,n = 1,is_free = 0}},
};
  --接受任务奖励
  accept_awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_10551_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_10551_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_10551_dialog_accept_npctalk_4",
	buttons = {
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_10551_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_10551_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_10551_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 1,
	npc_talk ="#td_10551_dialog_end_npctalk_5",
	buttons = {
        { player_talk = "#td_10551_dialog_end_player_talk_5_1" ,dest_type = 1 ,dest_window_id = 6 ,func_code = 0},
	...
	parent_id = 5,
	window_type = 2,
	npc_talk ="#td_10551_dialog_end_npctalk_6",
	buttons = {
