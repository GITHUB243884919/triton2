task = {
  ...
  --护送NPC路径
  npc_waypoints = {};
  drop_items = {{npc_id=44939 ,item_id=42721 ,n=1 ,p=1000, mapid=67},{npc_id=44940 ,item_id=42721 ,n=1 ,p=1000, mapid=67}};   --掉落道具
  --接任务条件
  accept_cond = 
  {
  ...
  complete_cond = 
  {
	{func=check_items_of_bag, args={id = 42721,n = 1}},
  };
  --任务完成奖励
  awards = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9262_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_9262_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_9262_dialog_accept_npctalk_4",
	buttons = {
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9262_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9262_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_9262_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_9262_dialog_end_npctalk_5",
	buttons = {
