task = {
  ...
  desc = "#td_9367_desc",  
  dest = "#td_9367_dest",  
  section = "#td_9367_section",  
  give_npc = 46895,    --发放NPC
  ...
  accept_cond = 
  {
	{func=check_before_task, args={task_id = 9366}},
  };
  --发布任务条件
  publish_cond = 
  {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9367_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_9367_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 4 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 3,
	npc_talk ="#td_9367_dialog_accept_npctalk_4",
	buttons = {
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9367_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_9367_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_9367_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 5 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_9367_dialog_end_npctalk_5",
	buttons = {
