task = {
  ...
  --接任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8343_dialog_accept_npctalk_1",
	buttons = {
        { player_talk = "#td_8343_dialog_accept_player_talk_1_1" ,dest_type = 1 ,dest_window_id = 10 ,func_code = 0},
	...
	parent_id = 1,
	window_type = 1,
	npc_talk ="#td_8343_dialog_accept_npctalk_10",
	buttons = {
        { player_talk = "#td_8343_dialog_accept_player_talk_10_1" ,dest_type = 1 ,dest_window_id = 11 ,func_code = 0},
	...
	parent_id = 10,
	window_type = 3,
	npc_talk ="#td_8343_dialog_accept_npctalk_11",
	buttons = {
        { player_talk = "#td_8343_dialog_accept_player_talk_11_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 3},
  ...
  --任务进行对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8343_dialog_doing_npctalk_2",
	buttons = {
  ...
  --完成任务对话
	...
	parent_id = 0,
	window_type = 1,
	npc_talk ="#td_8343_dialog_end_npctalk_3",
	buttons = {
        { player_talk = "#td_8343_dialog_end_player_talk_3_1" ,dest_type = 1 ,dest_window_id = 12 ,func_code = 0},
	...
	parent_id = 3,
	window_type = 2,
	npc_talk ="#td_8343_dialog_end_npctalk_12",
	buttons = {
        { player_talk = "#td_8343_dialog_end_player_talk_12_1" ,dest_type = 2 ,dest_window_id = 0 ,func_code = 4},
