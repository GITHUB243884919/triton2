...
uint16_t AGIPPayListQuery::getGameID(void) const
{
    return ntohs(_query_buff->us_Game_ID);
}

void AGIPPayListQuery::setGameID(uint16_t GameID)
{
    _query_buff->us_Game_ID = htons(GameID);
}

uint32_t AGIPPayListQuery::getGatewayID(void) const
{
    return ntohl(_query_buff->un_Gateway_ID);
}

void AGIPPayListQuery::setGatewayID(uint32_t GatewayID)
{
    _query_buff->un_Gateway_ID = htonl(GatewayID);
}
...
uint32_t AGIPPayListQueryRes::getResultCode(void) const
{
    return ntohl(_query_res_buff->un_Result_Code);
}

void AGIPPayListQueryRes::setResultCode(uint32_t ResultCode)
{
    _query_res_buff->un_Result_Code = htonl(ResultCode);
}

uint32_t AGIPPayListQueryRes::getGatewayID(void) const
{
    return ntohl(_query_res_buff->un_Gateway_ID);
}

void AGIPPayListQueryRes::setGatewayID(uint32_t GatewayID)
{
    _query_res_buff->un_Gateway_ID = htonl(GatewayID);
}
