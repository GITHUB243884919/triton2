...
uint16_t AGIPRoleEnterGame::getGameID(void)
{
    return ntohs(m_data->us_Game_ID);
}

uint32_t AGIPRoleEnterGame::getGatewayID(void)
{
...
void AGIPRoleEnterGame::setGameID(uint16_t usGameID)
{
    m_data->us_Game_ID = htons(usGameID);
    return;
}

void AGIPRoleEnterGame::setGatewayID(uint32_t unGatewayID)
{
