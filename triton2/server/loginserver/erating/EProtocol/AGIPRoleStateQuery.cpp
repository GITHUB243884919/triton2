...
uint32_t AGIPRoleStateQuery::getGatewayID(void)
{
    return (uint32_t)htonl(((SAGIPRoleStateQuery *)m_pucPDU)->un_Gateway_ID);
}
...
// Setter
void AGIPRoleStateQuery::setGatewayID(uint32_t unGatewayID)
{
    SAGIPRoleStateQuery *pSAGIPRoleStateQuery = (SAGIPRoleStateQuery *)m_pucPDU;
    pSAGIPRoleStateQuery->un_Gateway_ID = htonl(unGatewayID);
}
