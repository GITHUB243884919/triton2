...
int AGIPUserDataReport::getGatewayID(uint32_t *punGatewayID)
{
    ASSERT(punGatewayID != NULL);
    SAGIPUserDataReport *pSAGIPUserDataReport = (SAGIPUserDataReport *)m_pucPDU;
    *punGatewayID = htonl(pSAGIPUserDataReport->un_Gateway_ID);
    return S_SUCCESS;
}
...
int AGIPUserDataReport::setGatewayID(uint32_t unGatewayID)
{
    SAGIPUserDataReport *pSAGIPUserDataReport = (SAGIPUserDataReport *)m_pucPDU;
    pSAGIPUserDataReport->un_Gateway_ID = htonl(unGatewayID);
    return S_SUCCESS;
}
