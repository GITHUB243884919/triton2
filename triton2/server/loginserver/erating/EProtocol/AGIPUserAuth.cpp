...
int AGIPUserAuth::getGatewayID(uint32_t* punGatewayID)
{
    ASSERT(punGatewayID != NULL);
    SAGIPUserAuth *pSAGIPUserAuth = (SAGIPUserAuth *)m_pucPDU;
    *punGatewayID = htonl(pSAGIPUserAuth->un_Gateway_Id);
    return S_SUCCESS;
}

int AGIPUserAuth::getGameID(uint16_t* pucGameID)
{
    ASSERT(pucGameID != NULL);
    SAGIPUserAuth *pSAGIPUserAuth = (SAGIPUserAuth *)m_pucPDU;
    *pucGameID = htons(pSAGIPUserAuth->us_Game_Id);
    return S_SUCCESS;
}
...
int AGIPUserAuth::setGatewayID(uint32_t unGatewayID)
{
    SAGIPUserAuth *pSAGIPUserAuth = (SAGIPUserAuth*)m_pucPDU;
    pSAGIPUserAuth->un_Gateway_Id = htonl(unGatewayID);
    return S_SUCCESS;
}

int AGIPUserAuth::setGameID(uint16_t usGameID)
{
    SAGIPUserAuth *pSAGIPUserAuth = (SAGIPUserAuth*)m_pucPDU;
    pSAGIPUserAuth->us_Game_Id = htons(usGameID);
    return S_SUCCESS;
}
