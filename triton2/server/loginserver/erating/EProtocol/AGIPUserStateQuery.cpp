...
uint16_t AGIPUserStateQuery::getGameID(void)
{
    return ntohs(((SAGIPUserStateQuery *)m_pucPDU)->us_Game_ID);
}
...
// Setter
void AGIPUserStateQuery::setGameID(uint16_t usGameID)
{
    SAGIPUserStateQuery *pSAGIPUserStateQuery = (SAGIPUserStateQuery *)m_pucPDU;
    pSAGIPUserStateQuery->us_Game_ID = htons(usGameID);
}
