...
public:
    ...
    inline uint32_t getGatewayID(void) const;
    ...
    inline void setGatewayID(uint32_t unGatewayID);
...
uint32_t AGIPPfCharge::getGameID(void) const
{
...
uint32_t AGIPPfCharge::getGatewayID(void) const
{
...
void AGIPPfCharge::setGameID(uint32_t unGameID)
{
...
void AGIPPfCharge::setGatewayID(uint32_t unGatewayID)
{
