...
int AGIPUserAuthADID::getGatewayID(uint32_t* punGatewayID)
{
    ASSERT(punGatewayID != NULL);
    SAGIPUserAuthADID *pSAGIPUserAuthADID = (SAGIPUserAuthADID *)m_pucPDU;
    *punGatewayID = htonl(pSAGIPUserAuthADID->un_Gateway_Id);
    return S_SUCCESS;
}
...
int AGIPUserAuthADID::getGameID(uint16_t* pucGameID)
{
    ASSERT(pucGameID != NULL);
    SAGIPUserAuthADID *pSAGIPUserAuthADID = (SAGIPUserAuthADID *)m_pucPDU;
    *pucGameID = htons(pSAGIPUserAuthADID->us_Game_Id);
    return S_SUCCESS;
}
...
int AGIPUserAuthADID::setGatewayID(uint32_t unGatewayID)
{
    SAGIPUserAuthADID *pSAGIPUserAuthADID = (SAGIPUserAuthADID*)m_pucPDU;
    pSAGIPUserAuthADID->un_Gateway_Id = htonl(unGatewayID);
    return S_SUCCESS;
}
...
int AGIPUserAuthADID::setGameID(uint16_t usGameID)
{
    SAGIPUserAuthADID *pSAGIPUserAuthADID = (SAGIPUserAuthADID*)m_pucPDU;
    pSAGIPUserAuthADID->us_Game_Id = htons(usGameID);
    return S_SUCCESS;
}
